 ...
 */
final class Version20240218120544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64938A7F06B FOREIGN KEY (radiologist_id) REFERENCES radiologist (id)');
