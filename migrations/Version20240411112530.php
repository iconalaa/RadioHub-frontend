 ...
 */
final class Version20240411112530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prescription (id INT AUTO_INCREMENT NOT NULL, report_id INT DEFAULT NULL, contenu VARCHAR(255) NOT NULL, date DATE NOT NULL, signature_filename VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1FBFB8D94BD2A4C0 (report_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, doctor_id INT DEFAULT NULL, image_id INT DEFAULT NULL, interpretation_med VARCHAR(255) DEFAULT NULL, date DATE DEFAULT NULL, interpretation_rad VARCHAR(255) DEFAULT NULL, is_edited TINYINT(1) NOT NULL, INDEX IDX_C42F778487F4FB17 (doctor_id), UNIQUE INDEX UNIQ_C42F77843DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, brochure_filename VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) NOT NULL, date_birth DATE NOT NULL, gender VARCHAR(255) NOT NULL, cas_med VARCHAR(255) DEFAULT NULL, n_cnam VARCHAR(255) DEFAULT NULL, assurance VARCHAR(255) DEFAULT NULL, num_assurance VARCHAR(255) DEFAULT NULL, matricule VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE droit ADD CONSTRAINT FK_CB7AA7513CA9599F FOREIGN KEY (radioloqist_id) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F38A7F06B FOREIGN KEY (radiologist_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F6B899279 FOREIGN KEY (patient_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE interpretation ADD CONSTRAINT FK_EBDBD11738A7F06B FOREIGN KEY (radiologist_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE interpretation ADD CONSTRAINT FK_EBDBD1173DA5256D FOREIGN KEY (image_id) REFERENCES image (id)');
        $this->addSql('ALTER TABLE prescription ADD CONSTRAINT FK_1FBFB8D94BD2A4C0 FOREIGN KEY (report_id) REFERENCES report (id)');
        ...
        $this->addSql('ALTER TABLE report ADD CONSTRAINT FK_C42F77843DA5256D FOREIGN KEY (image_id) REFERENCES image (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prescription DROP FOREIGN KEY FK_1FBFB8D94BD2A4C0');
        ...
        $this->addSql('ALTER TABLE report DROP FOREIGN KEY FK_C42F77843DA5256D');
